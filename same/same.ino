const float Kp1 =3.48;   // Kp value that you have to change
const float Kd1=  2.95;   // Kd value that you have to change
const float Kp = 1.3;   // Kp value that you have to change
const float Kd = 2.6; 
const int setPoint = 35;    // Middle point of sensor array
const int baseSpeed = 80;    // Base speed for your motors
...
void loop() {
  ...
  positionVal = Serial2.read();    // Read incoming data and store in variable positionVal
