...
void loop()
{
  ...
  if (flag == 0)
  {
    if ((backsensor <= 120) && (avgls >= 45))
    {
      dialeft();
      correctl();

    }
    else if ((backsensor > 120 ) && (avgls < 45))
    {
      analogWrite(pwm1, 0);
  ...
  if (flag == 1)
  {
    if ((backsensor <= 250) && ((avgls < 140)))
    {
      diaright();
      correctr();
    }
    else if ((backsensor >= 250) && ((avgls >= 140)))
    {
      analogWrite(pwm2, 0);
  ...
  if (flag == 2 )
  {
    if ((frontsensor > 170) && (avgls >= 20))
    {
      dialeft();
      correctl();
    }
    else if ((frontsensor <= 170 ) && (avgls < 20))
    {
