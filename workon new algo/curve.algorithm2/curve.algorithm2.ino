...
void loop()
{
  ...
  if (flag == 1)
  {
    if ((backsensor <= 96) && (avgls > 45))
    {
      dialeft();
      correctl();

    }
    else if ((backsensor > 96) && (avgls < 45))
    {
      analogWrite(pwm1, 0);
...

  {
    ...
    else if ((backsensor >= 268) && (avgls > 150))
  ...
  {
    if ((frontsensor >154) && (avgls >50 ))
    {
      dialeft();
      correctl();

    }
    else if ((frontsensor > 154) && (avgls > 50))
    {
      flag = 8;
    }
