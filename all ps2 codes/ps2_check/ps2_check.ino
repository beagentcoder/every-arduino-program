...
void loop() {
  ...
  if (ps2x.Button(PSB_R3))
    ...
    mapped1 = map(ps2x.Analog(PSS_LY), 120, 0 , 0, 200);
    mapped2 = map(ps2x.Analog(PSS_LY), 140, 255 , 0, 200);
    mapped3 = map(ps2x.Analog(PSS_RX), 120, 0 , 0, 200);
    mapped4 = map(ps2x.Analog(PSS_RX), 140, 255 , 0, 200);
