...
void loop()
{
  ...
  if (flag == 0)  // first moving right
  {
    if ((backsensor < 127) && (avgls < 127))
    {
      diaright();
      correctr();

    }
    else if ((backsensor >= 127 ) && (avgls >= 127))
    {
      flag = 1;
      analogWrite(pwm2, 0);
  ...
  if (flag == 1)           // moving  diagonal right
  {
    if ((backsensor < 310) && ((avgls > 22)))
    {
    ...
    else if ((backsensor >= 310) && ((avgls <= 22)))
    {
      analogWrite(pwm1, 0);
...
//      flag = 2;
  ...
  if (flag == 2 )    //    moving diagonal  left
  {
